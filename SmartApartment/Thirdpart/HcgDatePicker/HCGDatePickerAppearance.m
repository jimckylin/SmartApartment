...
- (void)setupUI {
    ...
    NSDate *minDate = [NSDate sia_dateFromString:@"1900-01-01" withFormat:@"yyyy-MM-dd"];
    NSDate *maxDate = [NSDate date];
    
    _datePicker = [[HCGDatePicker alloc]initWithDatePickerMode:_dataPickerMode MinDate:minDate MaxDate:maxDate];
