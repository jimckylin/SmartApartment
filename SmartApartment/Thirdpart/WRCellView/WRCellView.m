...
- (void)layoutSubviews
{
    ...
    if (self.style & 0x1000)
    {
        CGSize leftLabelSize = [self.leftLabel.text sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:self.leftLabel.font.pointSize]}];
...
- (UIImageView *)rightIndicator {
    if (_rightIndicator == nil) {
        _rightIndicator = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"home_arrow_iconiphone"]];
    }
