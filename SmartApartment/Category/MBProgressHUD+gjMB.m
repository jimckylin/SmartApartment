...
{
    return [self showProgressHUDWithText:text view:view clear:NO];
}

+ (MBProgressHUD *)showProgressHUDWithText:(NSString *)text view:(UIView *)view clear:(BOOL)clear
{
    MBProgressHUD * hud = [MBProgressHUD showHUDAddedTo:view animated:YES];
    //hud.color = [UIColor colorWithRed:249/255.0 green:196/255.0 blue:32/255.0 alpha:1];
    hud.userInteractionEnabled = clear;
    hud.labelFont = [UIFont systemFontOfSize:13];
    hud.labelText = text;
